...
public class SalesHistoryController {
	...
	public ResponseEntity<PageResponse<SalesHistoryEntity>> getSalesHistory(Pageable page, SalesHistorySearchRequest request) {
	...
	public ResponseEntity<InputStreamResource> getSalesHistoryExcelFile(Pageable page, SalesHistorySearchRequest request) throws IOException {
